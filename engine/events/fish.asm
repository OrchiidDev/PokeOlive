...
;FishKelp used when fishing on a kelp tile
FishKelp:
; Using a fishing rod.
; Fish for monsters with rod e in encounter group d.
; Return monster d at level e.
	...
	ld b, e
	call GetKelpGroupIndex

	ld hl, KelpGroups
rept KELPGROUP_DATA_LENGTH
	add hl, de
endr
	call .FishKelp
...
.FishKelp:
; Fish for monsters with rod b from encounter data in KelpGroup at hl.
; Return monster d at level e.
...
GetKelpGroupIndex:
; Return the index of kelpgroup d in de.
...
INCLUDE "data/wild/fishkelp.asm"
