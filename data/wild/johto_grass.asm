...
JohtoGrassWildMons:
	...
	db 5, NATU
	db 6, NATU
	db 4, TAILLOW ;BRONZOR
	db 5, TAILLOW ;BRONZOR
	; nite
	db 4, TAILLOW ;BRONZOR
	db 6, TAILLOW ;BRONZOR
	db 7, TAILLOW ;BRONZOR
	db 5, NATU
	db 6, NATU
	db 7, MURKROW
	db 7, MURKROW
